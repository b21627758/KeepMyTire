# Generated by Django 3.0.8 on 2020-08-11 19:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tire', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Tire')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, 'Done'), (0, 'Waiting'), (3, 'Passed')], default=0)),
